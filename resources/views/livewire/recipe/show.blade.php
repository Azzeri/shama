...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        $this->redirectRoute('recipe.index');
    }
...
?>
<section>
    <x-mary-header title="{{ $recipe ? $recipe->name : 'Dodaj przepis' }}" separator size="text-md" />
    ...
    <x-mary-form wire:submit="save">
        ...
        <div class="flex items-end gap-2">
            ...
            <div class="w-25">
                <x-mary-input label="Ilość" wire:model="ingredientQuantityToAdd" placeholder="Podaj ilość..." inline />
            </div>
        ...
        <x-textarea label="Opis" wire:model="content" placeholder="Krok 1..." hint="Max 500 chars" rows="15" />
